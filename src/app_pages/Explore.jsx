...
const featuredContent = {
    sleep: {
        ...
        gradient: 'linear-gradient(135deg, #1a0a2e 0%, #2d1b69 40%, #4c1d95 100%)',
        accentColor: '#a78bfa',
        icon: Moon,
        featured: {
    ...
    workout: {
        ...
        gradient: 'linear-gradient(135deg, #b91c1c 0%, #dc2626 40%, #ef4444 100%)',
        accentColor: '#fca5a5',
        icon: Dumbbell,
        featured: {
    ...
    mindset: {
        ...
        gradient: 'linear-gradient(135deg, #4a1942 0%, #6b2fa0 40%, #7c3aed 100%)',
        accentColor: '#c4b5fd',
        icon: Brain,
        featured: {
            title: 'Daily Calm',
